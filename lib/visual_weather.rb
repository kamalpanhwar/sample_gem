...
require 'visual_weather/task_definition/base'
require 'visual_weather/task_definition/importer'
require 'visual_weather/task_definition/exporter'
require 'visual_weather/railtie' if defined?(Rails)
